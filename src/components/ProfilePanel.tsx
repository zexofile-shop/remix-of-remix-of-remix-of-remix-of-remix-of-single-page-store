      ...
      <DialogContent className="max-w-[340px] rounded-3xl p-0 overflow-hidden border-0 shadow-2xl">
        ...
        <div className="p-4 pt-2 space-y-2">
          <button
            ...
            className="w-full p-3.5 flex items-center gap-3 rounded-2xl bg-secondary/50 hover:bg-secondary border border-border/50 hover:border-border transition-all group text-left"
          >
            <div className="p-2 bg-primary/10 rounded-xl group-hover:bg-primary/15 transition-colors">
              <ShoppingBag className="h-4 w-4 text-primary" />
            </div>
            <div className="flex-1">
              <p className="font-medium text-sm text-foreground">My Purchases</p>
              <p className="text-[11px] text-muted-foreground">View orders & download files</p>
            </div>
          ...
          {isAdmin && (
            <button
              ...
              className="w-full p-3.5 flex items-center gap-3 rounded-2xl bg-gradient-to-r from-primary/10 to-primary/5 hover:from-primary/15 hover:to-primary/10 border border-primary/20 hover:border-primary/30 transition-all group text-left"
            >
              <div className="p-2 bg-primary/15 rounded-xl group-hover:bg-primary/20 transition-colors">
                <Shield className="h-4 w-4 text-primary" />
              </div>
              <div className="flex-1">
                <p className="font-medium text-sm text-foreground">Admin Panel</p>
                <p className="text-[11px] text-muted-foreground">Manage products & orders</p>
              </div>
          ...
          <div className="pt-1">
            <button
              ...
              className="w-full p-3 flex items-center gap-3 rounded-2xl hover:bg-destructive/5 transition-colors group text-left"
            >
              <div className="p-2 bg-destructive/10 rounded-xl group-hover:bg-destructive/15 transition-colors">
